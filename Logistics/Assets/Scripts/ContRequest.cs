...
public class ContRequest : MonoBehaviour
{
    ...
    public void GenRequsts(){
        requests = new List<Request>{
            ...
            new Request(1, 1, "Стол", 30, 10, "Москва", "12.05.2025", "10:00", "Питер", "13.05.2025", "15:00", 
                0, 2, statusRequest.work), 
            new Request(2, 2, "Стул", 30, 10, "Питер", "12.05.2025", "10:00", "Казань", "13.05.2025", "15:00", 
                0, 2, statusRequest.work), 
            new Request(3, 3, "Холодильник", 30, 10, "Казань", "12.05.2025", "10:00", "Волгоград", "13.05.2025", "15:00", 
                0, 2, statusRequest.work), 
            new Request(4, 4, "Дверь", 30, 10, "Волгоград", "12.05.2025", "10:00", "Пенза", "13.05.2025", "15:00", 
                0, 2, statusRequest.work), 
            new Request(5, 5, "Вешалки", 30, 10, "Пенза", "12.05.2025", "10:00", "Новогород", "13.05.2025", "15:00", 
                0, 2, statusRequest.work), 
            new Request(6, 6, "Бутылки", 30, 10, "Новогород", "12.05.2025", "10:00", "Саратов", "13.05.2025", "15:00", 
                0, 2, statusRequest.work), 
        };
    }
